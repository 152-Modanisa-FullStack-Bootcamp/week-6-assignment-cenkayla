...
func (m *MockIHandler) UserHandler(w http.ResponseWriter, r *http.Request) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "UserHandler", w, r)
}

// UserHandler indicates an expected call of UserHandler.
func (mr *MockIHandlerMockRecorder) UserHandler(w, r interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UserHandler", reflect.TypeOf((*MockIHandler)(nil).UserHandler), w, r)
}
